...
public class BorderRightStyleMaker extends  GenericBorderStyle {
    ...
    protected BorderRightStyleMaker(String name) {
	super(name);
...
sbExpr.append("-style");
    ...
    public Property getShorthand(PropertyList propertyList) {
      ...
      if (p == null) {
         listprop = (ListProperty)propertyList.getExplicit("border-right");
         if (listprop != null) {
