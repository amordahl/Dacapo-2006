 ...
 *
 * $Id: PyCursor.java,v 1.36 2005/06/20 17:12:12 fwierzbicki Exp $
 *
...
public class PyCursor extends PyObject implements ClassDictInit, WarningListener {
  ...
  static public void classDictInit(PyObject dict) {
    ...
    dict.__setitem__("__version__", Py.newString("$Revision: 1.36 $").__getslice__(Py.newInteger(11), Py.newInteger(-2), null));
