 ...
 *
 * $Id: PyStatement.java,v 1.6 2005/06/20 17:12:13 fwierzbicki Exp $
 *
...
public class PyStatement extends PyObject {
    ...
    static public void classDictInit(PyObject dict) {
        ...
        dict.__setitem__("__version__", Py.newString("$Revision: 1.6 $").__getslice__(Py.newInteger(11), Py.newInteger(-2), null));
