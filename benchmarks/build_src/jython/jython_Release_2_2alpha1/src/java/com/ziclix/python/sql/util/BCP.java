 ...
 *
 * $Id: BCP.java,v 1.2 2005/02/23 04:26:20 bzimmer Exp $
 *
...
public class BCP extends PyObject implements ClassDictInit {
    ...
    static public void classDictInit(PyObject dict) {
        ...
        dict.__setitem__("__version__", Py.newString("$Revision: 1.2 $").__getslice__(Py.newInteger(11), Py.newInteger(-2), null));
 ...
 * @date $today.date$
 * @date last modified on $Date: 2005/02/23 04:26:20 $
